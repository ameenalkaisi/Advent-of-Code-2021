...
// checks if all elements are equal to 0
bool all_flashed(vector<vector<int>> energy_levels) {
...
int main(int argc, char **argv) {
    ...
    int final_step;
    for(final_step = 0; !all_flashed(octopus_level); ++final_step)
        simulate_step(octopus_level);

    cout << final_step << endl;
}