// note, I tried to predict diagonlizaiotn problem from this
// so it ended up being more complex, probably should have done the most
// efficient solution for each one separately now that I think about it
...
struct graph {
    ...
    void add_line(point p1, point p2) {
        ...
        // only adds lines if they are horizontal
